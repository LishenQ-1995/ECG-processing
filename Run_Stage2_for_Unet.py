...
sigwithnoise_test = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sigwithnoise_test.mat')
sigwithnoise_test = sigwithnoise_test['sigwithnoise_test']#3000*4000

sig_all_test = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sig_all_test.mat')
sig_all_test = sig_all_test['sig_all_test']#3000*4000

sigwithnoise_validation = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sigwithnoise_validation.mat')
sigwithnoise_validation = sigwithnoise_validation['sigwithnoise_validation']#3000*4000

sig_all_validation = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sig_all_validation.mat')
sig_all_validation = sig_all_validation['sig_all_validation']#3000*4000

sigwithnoise_train = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sigwithnoise_train.mat')
sigwithnoise_train = sigwithnoise_train['sigwithnoise_train']#3000*4000

sig_all_train = io.loadmat('/home/ps/QLS/双阶段去噪实验/0.6em/sig_all_train.mat')
...
pred_train = io.loadmat('/home/ps/QLS/双阶段去噪实验/Stage_1/Unet第一阶段的结果/pred_train.mat')
pred_train = pred_train['pred_train']#3000*4000

pred_vaild = io.loadmat('/home/ps/QLS/双阶段去噪实验/Stage_1/Unet第一阶段的结果/pred_vaild.mat')
pred_vaild = pred_vaild['pred_vaild']#3000*4000

pred_test = io.loadmat('/home/ps/QLS/双阶段去噪实验/Stage_1/Unet第一阶段的结果/pred_test.mat')
...
#        loss = criterion(output,preds)
    ...
    if val_loss < best_loss:
        ...
        torch.save(model.state_dict(), '/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/Unet_DRnet.pth')
        best_epoch=epoch
        best_loss = val_loss
...
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/train_loss_record.mat',{'train_loss_record':train_loss_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/val_loss_record.mat',{'val_loss_record':val_loss_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/test_loss_record.mat',{'test_loss_record':test_loss_record})

io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/train_SNR_record.mat',{'train_SNR_record':train_SNR_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/val_SNR_record.mat',{'val_SNR_record':val_SNR_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/test_SNR_record.mat',{'test_SNR_record':test_SNR_record})
...
model.load_state_dict(torch.load('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/Unet_DRnet.pth'))#读模型
model.eval()#进入评估模式

train_all = train_all.to(device)
pred_train=pred_sig(64,train_all)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/pred_train.mat',{'pred_train':pred_train})

vaild_all = vaild_all.to(device)
pred_vaild=pred_sig(64,vaild_all)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/pred_vaild.mat',{'pred_vaild':pred_vaild})

test_all = test_all.to(device)
pred_test=pred_sig(64,test_all)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_2/第二阶段_Unet的结果/pred_test.mat',{'pred_test':pred_test})
