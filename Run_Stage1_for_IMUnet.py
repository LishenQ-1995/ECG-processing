...
#        loss = criterion(output,preds)
    ...
    if val_loss < best_loss:
        ...
        torch.save(model.state_dict(), '/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/IMUnet.pth')
        best_epoch=epoch
        best_loss = val_loss
...
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/train_loss_record.mat',{'train_loss_record':train_loss_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/val_loss_record.mat',{'val_loss_record':val_loss_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/test_loss_record.mat',{'test_loss_record':test_loss_record})

io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/train_SNR_record.mat',{'train_SNR_record':train_SNR_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/val_SNR_record.mat',{'val_SNR_record':val_SNR_record})
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/test_SNR_record.mat',{'test_SNR_record':test_SNR_record})
...
model.load_state_dict(torch.load('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/IMUnet.pth'))#读模型
model.eval()#进入评估模式

sigwithnoise_train = sigwithnoise_train.to(device)
pred_train=pred_sig(64,sigwithnoise_train)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/pred_train.mat',{'pred_train':pred_train})

sigwithnoise_validation = sigwithnoise_validation.to(device)
pred_vaild=pred_sig(64,sigwithnoise_validation)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/pred_vaild.mat',{'pred_vaild':pred_vaild})

sigwithnoise_test = sigwithnoise_test.to(device)
pred_test=pred_sig(64,sigwithnoise_test)
io.savemat('/home/ps/QLS/双阶段去噪实验/Stage_1/IMUnet第一阶段的结果/pred_test.mat',{'pred_test':pred_test})
